...
export default function CozinhaAdmin() {
  ...
  useEffect(() => {
    ...
    if (!user) {
      toast.error('VocÃª precisa estar logado como Chef Neide');
      return;
    }
  ...
  const handleSave = () => {
    if (!form.nome || !form.descricao || !form.preco) {
      toast.error('Preencha nome, descriÃ§Ã£o e preÃ§o');
      return;
    }
    ...
    if (editId) {
      ...
      toast.success('Prato publicado no catÃ¡logo!');
    }
  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">ðŸ‘©â€ðŸ³ Admin - Chef Neide</h1>
          <p className="text-gray-400 mt-2">Publique seus pratos no catÃ¡logo</p>
        </div>

        {/* Form */}
        <div className="rounded-3xl p-6 bg-slate-900 border border-white/10 mb-8">
          <h2 className="text-xl font-bold text-white mb-6">
            {editId ? 'âœï¸ Editar Prato' : 'âž• Novo Prato'}
          </h2>
          ...
          <div className="space-y-4">
            ...
            <textarea
              placeholder="DescriÃ§Ã£o (ingredientes principais, modo de preparo)"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input
                type="text"
                placeholder="PorÃ§Ãµes (ex: 4 pessoas)"
                value={porcoes}
            ...
            >
              <option value="publicado">âœ… Publicado (VisÃ­vel)</option>
              <option value="pendente">â³ Pendente (Ocultado)</option>
            </select>
            ...
            <div className="flex gap-3 pt-4">
              ...
              >
                {editId ? 'ðŸ’¾ Atualizar' : 'âœ”ï¸ Publicar Prato'}
              </button>
              {editId && (
                <button
                  onClick={() => {
          ...
          {pratos.length === 0 ? (
            ...
            <AdminTable
              ...
              onDelete={(id) => {
                ...
                toast.success('Prato removido do catÃ¡logo');
              }}
              onToggle={(item) => {
