  ...
  return (
    <div className="min-h-screen bg-slate-950 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white">ðŸ‘¨â€âš–ï¸ Admin Master - Cozinha Chef Neide</h1>
          <p className="text-gray-400 mt-2">GestÃ£o centralizada de pratos e pedidos</p>
        </div>
        ...
        {tab === 'pratos' && (
          <div>
            <div className="mb-4 p-3 rounded-lg bg-blue-500/10 border border-blue-500/30 text-blue-300 text-sm">
              ðŸ’¡ Dica: Clique em "Gerenciar CatÃ¡logo" na pÃ¡gina inicial para publicar/editar pratos
            </div>
            <AdminTable
              items={pratos}
                ...
                >
                  <div className="flex justify-between items-start gap-4">
                    <div className="flex-1">
                      ...
                      {demand.contato && (
                        <p className="text-cyan-300 text-sm mt-2">ðŸ“ž {demand.contato}</p>
                      )}
                    </div>
                    <div className="text-right">
                      ...
                      >
                        ...
                        <option value="resolvido">âœ… Pronto</option>
