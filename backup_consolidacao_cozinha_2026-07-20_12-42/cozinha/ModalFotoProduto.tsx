...
interface ModalFotoProdutoProps {
  ...
  currentImage?: string;
  produtoNome?: string;
  // ðŸ”¥ ADICIONADO: suporte para id / produtoId
  id?: string;
  produtoId?: string;
  entityId?: string;
  tipo?: string;
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-gray-800">ðŸ“¸ Foto do Produto</h2>
        ...
        <div className="mb-4">
          ...
          />
          <p className="text-xs text-gray-400 mt-1">PNG, JPG, WEBP atÃ© 5MB</p>
        </div>
