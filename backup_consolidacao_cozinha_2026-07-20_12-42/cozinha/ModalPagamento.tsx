...
// ðŸŽ¨ UI - Modal de Pagamento Fluido
      ...
      <div className="bg-gray-800 rounded-2xl max-w-md w-full border border-gray-700 p-6 max-h-[90vh] overflow-y-auto">
          ...
          <>
            ...
            <div className="space-y-3 mb-6">
              ...
              >
                ...
                <span className="flex-1 text-left font-medium">PIX - InstantÃ¢neo</span>
              ...
              >
                ...
                <span className="flex-1 text-left font-medium">CartÃ£o de CrÃ©dito</span>
              ...
              >
                ...
                <span className="flex-1 text-left font-medium">DÃ©bito em Conta</span>
        ...
        {etapa === 'erro' && (
          <div className="text-center py-12">
            ...
            <p className="text-xl font-bold text-red-400">âŒ Erro no Pagamento</p>
            <p className="text-gray-400 mt-2">{errorMessage || 'Tente novamente ou use outro mÃ©todo'}</p>
            <button
              onClick={handleRetry}
