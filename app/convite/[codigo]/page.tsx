      ...
      <main className="max-w-2xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-white/10 rounded-2xl p-6 space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" /><span>R$5 de bônus na carteira digital</span></div>
            ...
            <div className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-green-400" /><span>Academia, Cozinha, Moto Táxi e muito mais</span></div>
        ...
        <div className="bg-white/10 rounded-2xl p-4">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={handleCompartilhar} className="bg-green-500 text-white px-4 py-3 rounded-xl hover:bg-green-600 transition"><Share2 className="w-4 h-4" /></button>
          </div>
        </div>
