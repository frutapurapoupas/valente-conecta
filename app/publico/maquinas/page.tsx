    ...
    <div className="min-h-screen bg-slate-950 py-8 px-4">
      <div className="mx-auto max-w-6xl rounded-3xl border border-white/10 bg-slate-900/90 backdrop-blur-xl p-6 shadow-2xl shadow-slate-950/40">
        <div className="mb-8 rounded-3xl bg-gradient-to-r from-cyan-600 via-blue-700 to-violet-700 p-6 text-white shadow-xl shadow-cyan-500/20">
          <h1 className="text-3xl font-extrabold">Aluguel de Máquinas</h1>
          <p className="mt-3 text-sm text-cyan-100/90 leading-6">
            Veja máquinas disponíveis para aluguel, compare preços e contato do fornecedor. Se ainda não encontrar o equipamento desejado, envie sua solicitação.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
          <div>
            <div className="rounded-3xl border border-white/10 bg-slate-950/90 p-6 shadow-xl shadow-slate-950/20">
              <h2 className="text-2xl font-bold text-white mb-4">Máquinas disponíveis</h2>
              {suppliers && suppliers.length > 0 ? (
                ...
                <div className="rounded-3xl bg-white/5 p-8 text-center text-gray-300">
                  <p className="text-lg font-semibold text-white mb-2">Nenhuma máquina encontrada</p>
                  <p>Se você é fornecedor, cadastre seu equipamento. Se é cliente, envie sua solicitação para que o admin encontre a máquina certa.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div>
            <div className="rounded-3xl border border-white/10 bg-slate-950/90 p-6 shadow-xl shadow-slate-950/20">
              ...
              <p className="text-gray-300 mb-6">
                Nossa equipe pode ajudar a buscar o equipamento ideal e conectar você ao fornecedor certo. Preencha sua demanda abaixo.
              </p>
              <DemandView category="MAQUINAS" title="Enviar solicitação de aluguel" />
            </div>
          </div>
        </div>
      </div>
