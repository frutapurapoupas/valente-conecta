...
export default function ModalAssinatura({ isOpen, onConfirm, onCancel }: ModalAssinaturaProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-900 rounded-2xl max-w-md w-full border border-yellow-500/30 p-6">
        ...
        <div className="flex gap-3 mt-6">
          <button
            onClick={onCancel}
            className="flex-1 px-4 py-3 bg-zinc-800 hover:bg-zinc-700 rounded-xl transition font-medium"
          >
            Cancelar
          </button>
          <button
