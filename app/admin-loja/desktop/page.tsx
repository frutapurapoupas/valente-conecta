...
export default function AdminLojaDesktopPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold">Admin Loja</h1>
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/admin-loja/layout-selection" className="p-2 rounded-lg bg-yellow-500/20 hover:bg-yellow-500/30 transition">
