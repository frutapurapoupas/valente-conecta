...
import {
  ...
  CreditCard, RotateCcw, X, Save, DollarSign, Bell, Star, Zap, Printer,
} from 'lucide-react'
import {
...
function ModalImpressao({ lancamentos, filtroMes, filtroTipo, filtroStatus, onFechar }: ModalImpressaoProps) {
  ...
  return (
    <>
      ...
      {/* versão para impressão — só aparece no print */}
