...
export default function SaudeReivindicacoesPage() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-3xl mx-auto">
      ...
      <p className="text-sm text-gray-500 -mt-4 mb-6">Esse controle é o mesmo usado em Diretório de Comércios.</p>
          ...
          {lista.map((r) => (
            <div key={r.id} className="bg-white border rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1 text-sm mb-3">
                ...
                <p><span className="text-gray-500">Tipo:</span> {TIPO_LABEL[r.dados_novos.tipo] || r.dados_novos.tipo}</p>
