...
const design = {
  ...
  valorDestaque: "text-3xl font-bold",
  valorPositivo: "text-green-600",
  valorNegativo: "text-red-600",
  valorNeutro: "text-blue-600",
  linhaInfo: "flex justify-between py-2 border-b border-gray-100 last:border-0",
  badge: "inline-block px-2 py-1 rounded-full text-xs font-medium",
  ...
  return (
    <div className={design.container}>
      <div className={design.maxWidth}>
        ...
        {/* INGREDIENTES COM PREÇOS RELATIVOS */}
        <div className={design.card}>
