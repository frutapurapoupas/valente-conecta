  ...
  return (
    <div className="p-16 bg-zinc-900 rounded-60 border-8 border-zinc-800 text-center">
      ...
      <div className="space-y-4">
        <button className="w-full bg-zinc-800 p-10 rounded-60 text-4xl font-black uppercase hover:bg-valente">Instalar Modo Espịo</button>
        <button className="w-full bg-zinc-800 p-10 rounded-60 text-4xl font-black uppercase hover:bg-emerald-600">Instalar PDV Padṛo</button>
      </div>
    </div>
  );
}
