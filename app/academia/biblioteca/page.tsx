...
const EXERCICIOS: ExercicioBiblioteca[] = [
  {
    ...
    equipamento: ['Barra', 'Banco'], descricao: 'Exercício fundamental para desenvolvimento do peitoral.',
    notaExplicativa: '🎯 Foco: Peitoral maior e tríceps. Mantenha a escápula retraída durante todo o movimento.',
    instrucoes: [
    ...
    dicas: ['Mantenha a escápula retraída', 'Não arqueie as costas', 'Respire corretamente'],
    videoUrl: '/videos/supino.mp4'
  },
  {
    id: '2', nome: 'Agachamento Livre', categoria: 'Pernas', nivel: 'intermediario',
    equipamento: ['Barra', 'Rack'], descricao: 'O rei dos exercícios de pernas.',
    notaExplicativa: '🏋️ Foco: Quadríceps, glúteos e isquiotibiais. Mantenha a coluna reta e o peito erguido.',
    instrucoes: [
    ...
    dicas: ['Não deixe os joelhos entrarem', 'Desça até pelo menos paralelo', 'Mantenha o peso nos calcanhares'],
  ...
  },
  {
    ...
    notaExplicativa: '📐 Foco: Dorsal e latíssimo. Contraia as escápulas no topo do movimento.',
    instrucoes: [
    ...
    dicas: ['Não use impulso', 'Contraia as escápulas', 'Desça lentamente'],
    videoUrl: '/videos/puxada.mp4'
  },
  {
    id: '4', nome: 'Rosca Direta', categoria: 'Bíceps', nivel: 'iniciante',
    equipamento: ['Barra', 'Halteres'], descricao: 'Exercício clássico para hipertrofia dos bíceps.',
    notaExplicativa: '💪 Foco: Bíceps braquial. Mantenha os cotovelos fixos ao lado do corpo.',
    instrucoes: [
    ...
    dicas: ['Não balance o corpo', 'Mantenha a tensão na descida', 'Use amplitude completa'],
    videoUrl: '/videos/rosca.mp4'
  },
  {
    id: '5', nome: 'Desenvolvimento Militar', categoria: 'Ombros', nivel: 'intermediario',
    equipamento: ['Barra', 'Halteres'], descricao: 'Exercício completo para desenvolvimento dos ombros.',
    notaExplicativa: '🎯 Foco: Deltoide anterior e lateral. Mantenha o core contraído.',
    instrucoes: [
  ...
  },
  {
    ...
    equipamento: [], descricao: 'Exercício isométrico para fortalecimento do core.',
    ...
    dicas: ['Comece com 30 segundos', 'Mantenha a respiração', 'Olhe para o chão'],
    videoUrl: '/videos/prancha.mp4'
  }
];

const CATEGORIAS = ['Todos', 'Peito', 'Costas', 'Pernas', 'Ombros', 'Bíceps', 'Abdômen', 'Core'];
...
export default function BibliotecaPage() {
  ...
  const filtrados = EXERCICIOS.filter(ex => {
    ...
    const matchNivel = nivelFiltro === 'Todos' || (nivelFiltro === 'Iniciante' && ex.nivel === 'iniciante') || (nivelFiltro === 'Intermediário' && ex.nivel === 'intermediario') || (nivelFiltro === 'Avançado' && ex.nivel === 'avancado');
      ...
      <header className="sticky top-0 z-30 bg-white border-b border-slate-200 px-4 py-4">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-2xl font-black text-gray-900">Biblioteca de Exercícios</h1>
          </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/50 flex items-end justify-center">
          <div className="bg-white rounded-t-3xl w-full max-w-2xl p-6 space-y-5 overflow-y-auto max-h-[90vh]">
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => setExercicioSelecionado(null)} className="text-2xl text-gray-500">×</button>
            </div>
            ...
            {exercicioSelecionado.videoUrl && (
              ...
              >
                ...
                <p className="text-sm text-gray-600">🎥 Clique para assistir ao vídeo demonstrativo</p>
              </div>
            )}
            ...
            {/* Equipamento */}
            <div>
              <h3 className="font-bold text-gray-900 mb-2">🛠️ Equipamento Necessário</h3>
