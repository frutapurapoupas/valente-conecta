...
import {
  ...
  TrendingDown,
  Loader2, AlertTriangle, Crown, User, Store, Bike,
} from 'lucide-react'
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const t3 = setTimeout(() => setSplashFase('pronto'), 6000)
    return () => {
      clearTimeout(t1)
      clearTimeout(t2)
      clearTimeout(t3)
  ...
  return (
    <>
      ...
      {splashFase !== 'pronto' && (
        <div
          className={`fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-gradient-to-br from-indigo-900 via-indigo-800 to-zinc-950 transition-all duration-1000 ${
            splashFase === 'saindo' ? 'opacity-0 scale-95 pointer-events-none' : 'opacity-100 scale-100'
          }`}
          style={{
        ...
        >
          <div className="flex flex-col items-center gap-6 animate-slowfadein">
            ...
            <h1 className="text-3xl font-black text-white drop-shadow-lg animate-slowfadein">
              Valente Conecta
            </h1>
            <p className="text-lg text-indigo-200 font-bold animate-slowfadein">
              Bem-vindo! Conectando oportunidades...
            </p>
          </div>
        </div>
      )}
      ...
      <div className="min-h-screen bg-zinc-950 text-white pb-24">
        ...
        <header className="sticky top-0 z-30 bg-zinc-950/95 backdrop-blur border-b border-zinc-900 px-4 py-3">
          <div className="flex items-center justify-between max-w-2xl mx-auto">
            <button
              ...
              className="p-2 bg-zinc-900 border border-zinc-800 rounded-xl md:hidden"
            >
        ...
        <main className="max-w-2xl mx-auto px-4 pt-5 space-y-5">
          ...
          {/* INDIQUE E GANHE */}
          <Link
            href="/carteira?tab=indicar"
            className="bg-gradient-to-r from-yellow-500 to-amber-500 rounded-2xl p-5 flex items-center gap-4 active:scale-95 transition-all"
          >
              ...
              ambulante: [
                {
                  href: '/ambulantes',
                  label: 'Minha Página',
                  sub: 'Como aparece para clientes',
                  border: 'border-amber-500/20',
                  bg: 'bg-amber-500/15',
                  icon: <Bike className="w-5 h-5 text-amber-400" />,
                },
              ...
              <div className="p-5 space-y-4">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-5 py-3 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-black transition-all"
                  >
                    Buscar
                  </button>
                </div>
                ...
                {searchResults.length > 0 && (
                  <div className="space-y-3">
                    <p className="text-sm text-zinc-500 font-bold uppercase">
                      {searchResults.length} resultado(s) próximos a você
                    </p>
                      ...
                      >
                        ...
                        <div className="px-4 pb-3 space-y-2 border-t border-zinc-700/50 pt-3">
                          <div className="flex items-center justify-between gap-2">
                            ...
                            <span className="text-sm font-black text-blue-300 flex-shrink-0">
                              {result.price}
                            </span>
                          </div>
                        ...
                        {result.locked ? (
                          ...
                          <div className="px-4 pb-4 pt-3 space-y-1.5 bg-emerald-500/5 border-t border-emerald-500/20">
                            <p className="text-sm font-black text-emerald-400 uppercase tracking-wider mb-2">
                              ✅ Acesso liberado
                            </p>
                            <p className="text-base text-zinc-300 flex items-center gap-2">
                              <Phone className="w-4 h-4 text-blue-400" />{' '}
                              <strong>{result.telefone}</strong>
                            </p>
                            <p className="text-base text-zinc-300 flex items-center gap-2">
                            ...
                            <p className="text-base text-zinc-300 flex items-center gap-2">
                              ...
                              {result.distanciaDetalhada} · {result.bairro}
                            </p>
                          </div>
                        )}
                      </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl w-full max-w-md p-6 space-y-4">
              ...
              <p className="text-base text-zinc-400">
                Loja: <strong className="text-white">{unlockTarget.store}</strong>
              </p>
              <p className="text-4xl font-black text-blue-400">R$ {unlockPrice.toFixed(2)}</p>
              <p className="text-base text-zinc-500">
                Após o pagamento você recebe telefone, e-mail e geolocalização completa.
              </p>
              ...
              <button
                ...
                className="w-full p-3 text-base text-zinc-500 hover:text-zinc-300 transition-colors"
              >
                Cancelar
              </button>
            </div>
        ...
        {splashFase !== 'pronto' && (
          <div
            className={`fixed inset-0 z-[60] bg-zinc-950 flex flex-col items-center justify-center gap-6 transition-opacity duration-500 ${
          ...
          >
            ...
            >
              ...
              <p className="text-zinc-400 text-base">
                ...
                <br />
                <span className="text-yellow-400 font-black">Valente Conecta</span>?
              </p>
            </div>
          </div>
        )}
          ...
          <div className="fixed inset-0 z-50 bg-zinc-950 flex flex-col items-center justify-center p-6 gap-8">
            <div className="text-center">
              ...
              <p className="text-zinc-400 text-sm">
                Escolha seu perfil para personalizar a tela inicial
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
              {([
                {
                  tipo: 'usuario_geral' as const,
                  emoji: '🔍',
                  label: 'Consumidor',
                  sub: 'Busco produtos e serviços na cidade',
                ...
                },
                {
                  ...
                  emoji: '🏪',
                  label: 'Lojista',
                  sub: 'Tenho uma loja ou comércio',
                ...
                },
                {
                  ...
                  emoji: '👷',
                  label: 'Profissional',
                  sub: 'Ofereço serviços autônomos',
