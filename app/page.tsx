...
// Definindo a interface para o contexto da aplicação
...
export default function HomePage() {
  ...
  const user = (appContext as any).user || null;
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Usando typeof window !== 'undefined' para verificar se está no cliente
    ...
    // Verificação segura para o window
    ...
    <div className="bg-gray-100 min-h-screen">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-[#0a1428] border-t border-white/10 py-3 z-50">
        <div className="flex justify-around items-center text-xs">
          <button onClick={() => router.push("/qr-code")} className="flex flex-col items-center transition">
