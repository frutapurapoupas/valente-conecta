...
export default function AdminLayout({
  ...
  // Se não estiver logado, não mostrar o layout
      ...
      >
        ...
        <div className={`absolute bottom-0 left-0 right-0 p-12 border-t ${sidebarCollapsed ? 'text-center' : ''}`}>
          <button 
            ...
            className={`flex items-center gap-8 px-8 py-6 text-red-600 hover:bg-red-50 rounded-xl w-full ${sidebarCollapsed ? 'justify-center' : ''}`}
          >
