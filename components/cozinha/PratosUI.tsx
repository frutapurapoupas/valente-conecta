...
// 🎨 DESIGN - UI de gerenciamento de pratos
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {prato.ativo ? (
                              <span className="text-xs bg-green-600/20 text-green-400 px-2 py-0.5 rounded-full">✅ Ativo</span>
                            ) : (
                              <span className="text-xs bg-gray-600/20 text-gray-400 px-2 py-0.5 rounded-full">❌ Inativo</span>
                            )}
                          </div>
