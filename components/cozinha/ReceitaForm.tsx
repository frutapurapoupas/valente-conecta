...
// 🎨 DESIGN - Formulário de edição de receita
...
export default function ReceitaForm({
  ...
  // Estado local para seleção de ingrediente
  ...
  // Função para adicionar ingrediente com validação
    ...
    return (
      <div className="min-h-screen bg-gray-900 text-white p-6">
        <div className="max-w-4xl mx-auto text-center py-12">
          <h1 className="text-2xl font-bold text-red-400">❌ Receita não encontrada</h1>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {mostrarHistorico && receita.historico && receita.historico.length > 0 && (
          <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-4 mb-6">
            <h3 className="text-sm font-semibold text-gray-400 mb-3">📜 Histórico de Versões</h3>
            <div className="space-y-2 max-h-40 overflow-y-auto">
              {receita.historico.slice().reverse().map((h: any, idx: number) => (
                <div key={h.id || idx} className="flex justify-between text-sm bg-gray-800/50 p-2 rounded-lg flex-wrap gap-2">
                  ...
                  <span className="text-gray-300">{h.porcoes} porções</span>
                  <span className="text-red-400">Custo: {formatarMoeda(h.custo_total)}</span>
                  <span className="text-green-400">Preço: {formatarMoeda(h.preco_sugerido)}</span>
        ...
        <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-6 mb-6">
          <h2 className="text-lg font-semibold mb-4 text-white">📋 Dados da Receita</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-1">Porções</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm text-gray-400 mb-1">Preço Sugerido (R$)</label>
              <input
                type="number"
                step="0.01"
        ...
        {/* Ingredientes */}
        <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-6 mb-6">
          <h2 className="text-lg font-semibold mb-4 text-white">🧪 Ingredientes</h2>
          ...
          <div className="flex flex-wrap gap-3 mb-4">
            ...
            >
              ...
              {ingredientesDisponiveis.length > 0 ? (
                ...
                <option value="" disabled>Nenhum ingrediente disponível</option>
              )}
            </select>
            <input
              type="number"
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-800/50">
                <tr>
                  ...
                  <th className="px-3 py-2 text-center text-gray-400">Ação</th>
                </tr>
              </thead>
        ...
        <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-6 mb-6">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex-1 min-w-[150px]">
              <label className="block text-sm text-gray-400 mb-1">Quantas porções?</label>
              <input
                type="number"
                min="1"
            ...
            <div className="flex-1 min-w-[120px]">
              <label className="block text-sm text-gray-400 mb-1">Custo por Porção</label>
          ...
          {calculoPorcoes && calculoPorcoes.ingredientes && calculoPorcoes.ingredientes.length > 0 && (
            <div className="mt-4 p-4 bg-gray-800/50 rounded-lg">
              <p className="text-sm text-gray-400 mb-2">
                📦 Ingredientes necessários para <span className="text-white font-medium">{quantidadePorcoes}</span> porções:
              </p>
        ...
        <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-6">
          <h2 className="text-lg font-semibold mb-4 text-white">💰 Resumo Financeiro</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <div className="bg-gray-800/50 rounded-lg p-3 text-center border border-gray-700">
              <p className="text-sm text-gray-400">Custo por Porção</p>
          ...
          {margem < 30 && receita.ingredientes && receita.ingredientes.length > 0 && (
            <div className="mt-3 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg flex items-start gap-2 text-yellow-400 text-sm">
              ...
              <span>⚠️ Margem baixa! Considere ajustar o preço ou reduzir custos.</span>
            </div>
          )}
        </div>
        ...
        <div className="mt-6 bg-gray-800/20 rounded-lg border border-gray-700 p-4">
          <h3 className="text-sm font-semibold text-gray-400 mb-2">💡 Dicas de Otimização</h3>
          <ul className="text-sm text-gray-500 space-y-1">
            <li>• 🎯 A régua de progresso mostra quanto falta para atingir a meta de peso de cada ingrediente</li>
            ...
            <li>• 📜 O histórico mantém todas as versões da receita para consulta</li>
          </ul>
        </div>
      </div>
    </div>
