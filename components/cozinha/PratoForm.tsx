  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <div>
            ...
            <h1 className="text-2xl font-bold flex items-center gap-2 mt-1">
              {isEdit ? '✏️ Editar Prato' : '🍽️ Novo Prato'}
            </h1>
            <p className="text-sm text-gray-400">
              {isEdit ? 'Atualize as informações do prato' : 'Crie um novo prato para o cardápio'}
            </p>
          </div>
          <button
            onClick={onSalvar}
        ...
        {/* Resto do formulário - mesmo código anterior */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Coluna Principal */}
          <div className="lg:col-span-2 space-y-6">
            {/* Dados Básicos */}
            <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-6">
              <h2 className="text-lg font-semibold mb-4">📋 Dados do Prato</h2>
            ...
            {/* Status */}
            <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-6">
              <h2 className="text-lg font-semibold mb-4">⚙️ Status</h2>
          ...
          <div className="space-y-6">
            {/* Imagem */}
            <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-6">
              <h2 className="text-lg font-semibold mb-4">🖼️ Imagem</h2>
              ...
              {showImageHelp && (
                <div className="mt-3 p-3 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                  <p className="text-xs text-blue-400">
                    💡 URL da imagem (deixe em branco para usar placeholder automático)
                  </p>
                  <input
                    type="text"
            ...
            <div className="bg-gray-800/20 rounded-lg border border-gray-700 p-4">
              <h3 className="text-sm font-semibold text-gray-400 mb-2">💡 Dicas</h3>
              <ul className="text-xs text-gray-500 space-y-1">
                <li>• Preencha todos os campos obrigatórios (*)</li>
                <li>• Adicione ingredientes para calcular o custo</li>
                <li>• A margem ideal é acima de 30%</li>
                <li>• Pratos inativos não aparecem no catálogo</li>
              </ul>
            </div>
          </div>
        </div>
