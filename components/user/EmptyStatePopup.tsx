  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl relative">
        ...
        {/* Aqui entra o formulÃ¡rio do image_82c9c4.jpg */}
        <h2 className="text-xl font-bold mb-4">Procurando por {categoria}?</h2>
        <p>Ainda nÃ£o temos cadastros, mas seus dados serÃ£o enviados automaticamente.</p>
        <button className="w-full bg-red-600 text-white py-3 rounded mt-4">Enviar SolicitaÃ§Ã£o</button>
      </div>
    </div>
  );
}
